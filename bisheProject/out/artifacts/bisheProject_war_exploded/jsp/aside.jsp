                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li id="f1">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath }/showTitle?page=1"> <i class="fa fa-edit fa-fw"></i>美发师职称</a>
                            </li>
                    ...
                    <li id="f8">
                        <a href="${pageContext.request.contextPath }/business?page=1">
                            <i class="fa fa-edit fa-fw"></i> 财务统计
                        </a>
                    </li>
